...
export default function StylesEditor({
  ...
  const inputClass = glass
    ? "w-full min-w-0 px-3 py-2 text-gray-600 bg-white/55 border border-white/60 rounded-lg focus:outline-none focus:ring-1 focus:ring-white/50 focus:border-white/50 disabled:bg-white/30 placeholder:text-gray-500 overflow-x-auto"
